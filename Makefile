#############################################################################
# Makefile for building: pcap_test
# Generated by qmake (3.1) (Qt 5.13.0)
# Project:  ../pcap_test/pcap_test.pro
# Template: app
# Command: /home/yoon/Qt/5.13.0/gcc_64/bin/qmake -o Makefile ../pcap_test/pcap_test.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
#############################################################################
...
INCPATH       = -I../pcap_test -I. -I../../Qt/5.13.0/gcc_64/mkspecs/linux-g++
QMAKE         = /home/yoon/Qt/5.13.0/gcc_64/bin/qmake
DEL_FILE      = rm -f
...
INSTALL_DIR   = cp -f -R
QINSTALL      = /home/yoon/Qt/5.13.0/gcc_64/bin/qmake -install qinstall
QINSTALL_PROGRAM = /home/yoon/Qt/5.13.0/gcc_64/bin/qmake -install qinstall -exe
DEL_FILE      = rm -f
SYMLINK       = ln -f -s
DEL_DIR       = rmdir
MOVE          = mv -f
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = pcap_test1.0.0
DISTDIR = /home/yoon/Downloads/build-pcap_test-Desktop_Qt_5_13_0_GCC_64bit-Debug/.tmp/pcap_test1.0.0
LINK          = g++
LFLAGS        = 
LIBS          = $(SUBLIBS) -lpcap   
AR            = ar cqs
...
DIST          = ../../Qt/5.13.0/gcc_64/mkspecs/features/spec_pre.prf \
		...
		../pcap_test/pcap_test.pro  ../pcap_test/main.cpp
QMAKE_TARGET  = pcap_test
DESTDIR       = 
TARGET        = pcap_test
...
Makefile: ../pcap_test/pcap_test.pro ../../Qt/5.13.0/gcc_64/mkspecs/linux-g++/qmake.conf ../../Qt/5.13.0/gcc_64/mkspecs/features/spec_pre.prf \
		../../Qt/5.13.0/gcc_64/mkspecs/common/unix.conf \
		../../Qt/5.13.0/gcc_64/mkspecs/common/linux.conf \
		../../Qt/5.13.0/gcc_64/mkspecs/common/sanitize.conf \
		../../Qt/5.13.0/gcc_64/mkspecs/common/gcc-base.conf \
		...
		../../Qt/5.13.0/gcc_64/mkspecs/features/yacc.prf \
		../../Qt/5.13.0/gcc_64/mkspecs/features/lex.prf \
		../pcap_test/pcap_test.pro
	$(QMAKE) -o Makefile ../pcap_test/pcap_test.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
...
main.o: ../pcap_test/main.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o main.o ../pcap_test/main.cpp
